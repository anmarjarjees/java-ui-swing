...
/*
* JFrame is one of the javax.swing package classes
*/

/* 
* Notice below => we used two import statements 
* and we will use more import statements for other components that we need to add!
* We could combine all of them => import.javax.swing.*;
*/
